          ...
          <Row className="mt-5">
            <Col md={3} className="text-center cardw">
              <Card style={{ width: "100%", borderRadius:"25px"}}>
                <Card.Img variant="top" src={hourImg} style={{borderRadius:'25px'}}/>
              </Card>
              <h4 className="pt-4 paratxt">Hourly Booking</h4>
            </Col>
            <Col md={3} className="text-center">
            <Card style={{ width: "100%", borderRadius:"25px"}}>
                <Card.Img variant="top" src={airTrans} style={{borderRadius:'25px'}}/>
              </Card>
              <h4 className="pt-4 paratxt">Airport Transfer</h4>
            </Col>
            <Col md={3} className="text-center">
            <Card style={{ width: "100%", borderRadius:"25px"}}>
                <Card.Img variant="top" src={cityTran} style={{borderRadius:'25px'}}/>
              </Card>
              <h4 className="pt-4 paratxt">City Transfers</h4>
            </Col>
            <Col md={3} className="text-center">
            <Card style={{ width: "100%", borderRadius:"25px"}}>
                <Card.Img variant="top" src={CorTrans} style={{borderRadius:'25px'}}/>
              </Card>
