          ...
          <Row className="mt-5 d-flex flex-wrap justify-content-center align-items-stretch">
            <Col xs={12} sm={12} md={3} lg={3} className="text-center">
              <Card style={{ width: "100%", borderRadius: "20px" }}>
                ...
                />
                <Card.Body>
                  <Card.Title className="bg-dark rounded-5 text-light py-2 mx-3 paratxt">
                    {" "}
                    John D
                  </Card.Title>
                  ...
                  <Card.Text className="para py-2 justify-content">
                    "Great experience! The driver was courteous, avoided
                    traffic, and the car was clean. I'll definitely use this
                    service again."
                  </Card.Text>
                </Card.Body>
              </Card>
              ...
              <Card style={{ width: "100%", borderRadius: "20px" }}>
                ...
                <Card.Body>
                  ...
                  <Card.Text className="para py-2">
                    "Exceptional service! Our chauffeur was punctual,
                    professional, and made the journey enjoyable. Highly
                    recommended!"
                  </Card.Text>
                </Card.Body>
              </Card>
            ...
            <Col xs={12} sm={12} md={3} lg={3} className="text-center">
              <Card style={{ width: "100%", borderRadius: "20px" }}>
                ...
                <Card.Body>
                  ...
                  <Card.Text className="para py-2">
                    "Amazing service! Our chauffeur went above and beyond for a
                    pleasant trip. Impressive attention to detail. Five stars!"
                  </Card.Text>
                </Card.Body>
              </Card>
            </Col>
            <Col xs={12} sm={12} md={3} lg={3} className="text-center">
              <Card style={{ width: "100%", borderRadius: "20px" }}>
                ...
                <Card.Body>
                  ...
                  <Card.Text className="para py-2">
                    "Very satisfied with the service. The driver was friendly
                    and professional. Despite a slight pickup delay."
                  </Card.Text>
                </Card.Body>
              </Card>
            </Col>
